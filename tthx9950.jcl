//TTHX9950 JOB 'RDAB,4120,PR32','B430134',MSGCLASS=Z,REGION=7M,         
//       SCHENV=TEST                                                    
...
//*                                                                     
//* ***    %%LIBSYM MJ.EVTA.PRV.CAFORM %%MEMSYM OUTLKHU                 
//* ***    %%LIBSYM MJ.EVTA.PRV.CAFORM %%MEMSYM OUTLKHV                 
//* ***    %%LIBSYM MJ.EVTA.PRV.CAFORM %%MEMSYM OUTLKHW                 
//*                                                                     
...
//       DISP=SHR                                                       
//SAIDA1   DD DSN=MX.TTHX.BDRPTRAN.CARTJUR(+1),                         
//       DISP=(,CATLG,DELETE),                                          
//       UNIT=(DISCO,02),                                               
//       SPACE=(TRK,(002220,0444),RLSE),                                
//       DCB=(MX.A,LRECL=0396,RECFM=FB)                                 
//SAIDA2   DD DSN=MX.TTHX.BDRPTRAN.CARTFIS(+1),                         
//       DISP=(,CATLG,DELETE),                                          
//       UNIT=DISCO,                                                    
...
//SYSIN    DD *                                                         
 ...
 OUTFIL INCLUDE=((04,6,CH,EQ,C'101010'),AND,                            
                 111,6,CH,EQ,C'000260'),FNAMES=SAIDA1                   
 OUTFIL INCLUDE=((04,6,CH,EQ,C'301010'),AND,                            
...
//       DISP=SHR                                                       
//ARQSAIDA DD DSN=MX.TTHX.INATIVA.SEMATU.CARTAJUR(+1),                  
//       DISP=(,CATLG,DELETE),                                          
//       UNIT=(DISCO,08),                                               
//       SPACE=(TRK,(020000,4000),RLSE),                                
//       DCB=(MX.A,LRECL=3400,RECFM=FB,BUFNO=30)                        
//BDRPSCOR DD DSN=MX.TTHX.INATIVA.SEMATU.DESPRJUR(+1),                  
//       DISP=(,CATLG,DELETE),                                          
//       UNIT=(DISCO,08),                                               
//       SPACE=(TRK,(020000,4000),RLSE),                                
...
//ARQEXTRC DD DSN=MX.CACS.EXTRACT.SEMATU.GERAL.SEL(0),                  
//       DISP=SHR                                                       
//ARQSAIDA DD DSN=MX.TTHX.INATIVA.SEMATU.CARTAFIS(+1),                  
//       DISP=(,CATLG,DELETE),                                          
//       UNIT=(DISCO,08),                                               
//       SPACE=(TRK,(020000,4000),RLSE),                                
//       DCB=(MX.A,LRECL=3400,RECFM=FB,BUFNO=30)                        
//BDRPSCOR DD DSN=MX.TTHX.INATIVA.SEMATU.DESPRFIS(+1),                  
//       DISP=(,CATLG,DELETE),                                          
//       UNIT=(DISCO,08),                                               
//       SPACE=(TRK,(020000,4000),RLSE),                                
//       DCB=(MX.A,LRECL=0396,RECFM=FB,BUFNO=30)                        
...
//       DISP=SHR                                                       
//SORTOUT  DD DSN=MX.TTHX.DB280.REP360WK.COMPARA(+1),                   
//       DISP=(,CATLG,DELETE),                                          
//       UNIT=(DISCO,40),                                               
//       SPACE=(TRK,(020000,4000),RLSE),                                
...
//SYSIN    DD *                                                         
 ...
 INCLUDE COND=((08,6,CH,EQ,C'101010',OR,08,6,CH,EQ,C'301010'),AND,      
...
//       DISP=SHR                                                       
//SORTOUT  DD DSN=MX.TTHX.EXTRACT.SEMATU.COMPARA(+1),                   
//       DISP=(,CATLG,DELETE),                                          
//       UNIT=(DISCO,40),                                               
//       SPACE=(TRK,(020000,4000),RLSE),                                
//       DCB=(MX.A,LRECL=24,RECFM=FB)                                   
...
//       DISP=SHR                                                       
//DIVERGE  DD DSN=MX.TTHX.DIVERGE(+1),                                  
//       DISP=(,CATLG,DELETE),                                          
//       UNIT=(DISCO,08),                                               
//       SPACE=(TRK,(020000,4000),RLSE),                                
//       DCB=(MX.A,LRECL=024,RECFM=FB)                                  
//PRODSEM  DD DSN=MX.TTHX.PRODSEM(+1),                                  
//       DISP=(,CATLG,DELETE),                                          
//       UNIT=(DISCO,03),                                               
//       SPACE=(TRK,(006210,1242),RLSE),                                
//       DCB=(MX.A,LRECL=24,RECFM=FB)                                   
//TESTSEM  DD DSN=MX.TTHX.TESTSEM(+1),                                  
//       DISP=(,CATLG,DELETE),                                          
//       UNIT=(DISCO,08),                                               
//       SPACE=(TRK,(020000,4000),RLSE),                                
//       DCB=(MX.A,LRECL=24,RECFM=FB)                                   
