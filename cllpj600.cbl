...
BRQ141     05  WRK-WKCARCR             PIC  X(003)         VALUE SPACES.
      ...
      *----------------------------------------------------------------*
       01  WRK-MOVREG.                                                  
           ...
           05  WRK-MOVLT.
               07 WRK-MOVTAXA-CONTRATO       PIC  9(02)V9(06) COMP-3.
               07 WRK-MOVVR-REMUNERATORIO      PIC S9(13)V99 COMP-3.
               07 WRK-MOVVALOR-MORATORIO     PIC S9(13)V99 COMP-3.
               07 WRK-MOVVALOR-MULTA         PIC S9(13)V99 COMP-3.
               07 WRK-MOVDESP-JUD-CUSTAS     PIC S9(11)V99 COMP-3.
               07 WRK-MOVHONORARIOS          PIC S9(11)V99 COMP-3.
               07 WRK-MOVVL-TOTAL-DIVIDA     PIC S9(15)V99 COMP-3.
               07 WRK-MOVVL-TAXA-TARIFA      PIC S9(15)V99 COMP-3.
               07 WRK-MOVVL-IOF              PIC S9(13)V99 USAGE COMP-3.
               07 WRK-MOVVL-CORRECAO         PIC S9(13)V99 USAGE COMP-3.
               07 WRK-MOVVL-JUROS-12PCAA     PIC S9(13)V99 USAGE COMP-3.
               07 WRK-MOVPERIODICIDADE       PIC S9(02)    USAGE COMP-3.
               07 FILLER                  PIC  X(13).
      ...
      *----------------------------------------------------------------*
       01  WRK-REGMOVTO.                                                
           ...
           05  WRK-LT.
               07 WRK-TAXA-CONTRATO       PIC  9(02)V9(06) COMP-3.
               07 WRK-VR-REMUNERATORIO      PIC S9(13)V99 COMP-3.
               07 WRK-VALOR-MORATORIO     PIC S9(13)V99 COMP-3.
               07 WRK-VALOR-MULTA         PIC S9(13)V99 COMP-3.
               07 WRK-DESP-JUD-CUSTAS     PIC S9(11)V99 COMP-3.
               07 WRK-HONORARIOS          PIC S9(11)V99 COMP-3.
               07 WRK-VL-TOTAL-DIVIDA     PIC S9(15)V99 COMP-3.
               07 WRK-VL-TAXA-TARIFA      PIC S9(15)V99 COMP-3.
               07 WRK-VL-IOF              PIC S9(13)V99 USAGE COMP-3.
               07 WRK-VL-CORRECAO         PIC S9(13)V99 USAGE COMP-3.
               07 WRK-VL-JUROS-12PCAA     PIC S9(13)V99 USAGE COMP-3.
               07 WRK-PERIODICIDADE       PIC S9(02)    USAGE COMP-3.
               07 FILLER                  PIC  X(13).
...
CPMCAC                                 PIC  9(002).                     
      ...
      *================================================================*
       0040-DTVAZIO.                                                    
      *================================================================*
           DISPLAY '*CLLPJ600* ARQUIVO DE DATA ESTA VAZIO'              
           UPON OPERADOR.                                               
      *================================================================*
       0050-PEDENOVO.                                                   
      *================================================================*
           DISPLAY                                                      
           '*CLLPJ600* TECLAR A DATA DO MOVIMENTO NO FORMATO DDMMAAAA'  
           WRK-ENTNORM                                                  
           UPON OPERADOR                                                
...
CPMCAC     IF      WRK-04-RED          NOT GREATER ZEROS                
      ...
      *================================================================*
           DISPLAY                                                      
           '*CLLPJ600* DATA TECLADA ESTA INCONSISTENTE'                 
           UPON OPERADOR                                                
           GO TO 0050-PEDENOVO.                                         
      *================================================================*
       0090-MOVDATB.                                                    
...
CPMCAC     IF      WRK-05              NOT EQUAL  7000                  
      ...
      *================================================================*
           ...
           UPON    OPERADOR                                             
           DISPLAY                                                      
           '** CLLPJ600 ** SR. OPERADOR,  TABELA EXCEDEU 13000   *'     
           UPON    OPERADOR                                             
           DISPLAY                                                      
...
CPMCAC     MOVE    WRK-WKAGCR          TO  WRK-55                       
      ...
      ****************************************************
      ******    CAMPOS DA LEI DA TRANSPARENCIA************
      ****************************************************

           MOVE WRK-MOVTAXA-CONTRATO      TO WRK-TAXA-CONTRATO
           MOVE WRK-MOVVR-REMUNERATORIO   TO WRK-VR-REMUNERATORIO
           MOVE WRK-MOVVALOR-MORATORIO    TO WRK-VALOR-MORATORIO
           MOVE WRK-MOVVALOR-MULTA        TO WRK-VALOR-MULTA
           MOVE WRK-MOVDESP-JUD-CUSTAS    TO WRK-DESP-JUD-CUSTAS
           MOVE WRK-MOVHONORARIOS         TO WRK-HONORARIOS
           MOVE WRK-MOVVL-TOTAL-DIVIDA    TO WRK-VL-TOTAL-DIVIDA
           MOVE WRK-MOVVL-TAXA-TARIFA     TO WRK-VL-TAXA-TARIFA
           MOVE WRK-MOVVL-IOF             TO WRK-VL-IOF
           MOVE WRK-MOVVL-CORRECAO        TO WRK-VL-CORRECAO
           MOVE WRK-MOVVL-JUROS-12PCAA    TO WRK-VL-JUROS-12PCAA
           MOVE WRK-MOVPERIODICIDADE      TO WRK-PERIODICIDADE
