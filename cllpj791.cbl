      ...
      *    PROGRAMA....:  CLLPJ791                                     *
      *    DATA........:  ABRIL / 2013                                 *
      *    PROGRAMADOR.:  FRANCISCO FREIRE                             *
      *    ANALISTA....:  FRANCISCO FREIRE                             *
      *----------------------------------------------------------------*
      *    OBJETIVO....:  GERAR ARQUIVO DE NAOEMITE PARA CEDD          *
      *----------------------------------------------------------------*
      *    OBS.........:  PROGRAMA CLONE CLLP0791                      *
      *----------------------------------------------------------------*
      *    ARQUIVOS....:  DDNAME    | E/S  |INCLUDE/BOOK | TAMANHO     *
      *                   AVISOENT     E      I#CLLPLJ      1290       *
      *                   AVISOSAI     S      I#CLLPLJ      1290       *
      ...
      *----------------------------------------------------------------*
       FILE                            SECTION.                         
      *----------------------------------------------------------------*
      *  INPUT:  AVISOENT - ARQUIVO DE AVISOS              - LRECL=1290
      *                        -*- I#CLLPLJ -*-                        *
      *----------------------------------------------------------------*
       FD  AVISOENT                                                     
       ...
       01  FD-REG-AVISOENT                 PIC  X(1290).
      *----------------------------------------------------------------*
      *  OUTPUT: AVISOSAI - ARQUIVO DE AVISOS OK           - LRECL=1290*
      *                        -*- I#CLLPZG -*-                        *
      *----------------------------------------------------------------*
       FD  AVISOSAI                                                     
           LABEL RECORD STANDARD                                        
      ...
      *----------------------------------------------------------------*
      *----------------------------------------------------------------*
       77  FILLER PIC X(33) VALUE  '* CLLPJ791 - INICIO DA WORKING  *'. 
      *----------------------------------------------------------------*
      *                                                                 
       ...
       77  WRK-PROGRAMA                PIC  X(008) VALUE 'CLLPJ791'.    
      ...
      *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *
       01  FILLER   PIC  X(32) VALUE '*   FIM DA WORKING CLLPJ791    *'.
      *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *
      ...
      *                                                                 
           ...
           MOVE AVI-CGCCPFAVAL         TO CLLPZF-CD-CPF-CNPJ.
      ...
      *----------------------------------------------------------------*
           ...
           DISPLAY '************ PROGRAMA CLLPJ791 *************'.      
           DISPLAY '*                                          *'.      
           DISPLAY '* PROGRAMA CLLPJ791 ENCERRADO COM SUCESSO  *'.      
           DISPLAY '*                                          *'.      
           DISPLAY '************ PROGRAMA CLLPJ791 *************'.      
