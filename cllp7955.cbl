      ...
      *----------------------------------------------------------------*
       ...
       FILE-CONTROL.                                                    
           ...
           SELECT  TABELA      ASSIGN   TO  TABELA
      ...
      *----------------------------------------------------------------*
      *    INPUT:  ARQUIVO UF PARTICIPANTES DA LEI DA TRANSPARENCIA    *
      *            ORG. SEQUENCIAL     -   LRECL   =   02              *
      *----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
       ...
       77  WRK-EMPRESA-BRADESCO        PIC  9(01)          VALUE 1.     
       77  WRK-EMPRESA-LEASING         PIC  9(01)          VALUE 2.     
                                                                        
       01  WRK-DESCRIC                 PIC  X(020)         VALUE SPACES.
                                                                        
       01  WRK-TABELA-CARREGADA        PIC  X(001)         VALUE 'N'.
       01  WRK-UF-PARTICIPANTE         PIC  X(001)         VALUE 'N'.
       01  WRK-TABELA-VAZIA            PIC  X(001)         VALUE 'S'.
       01  WRK-LEILT-ZERADOS           PIC  X(001)         VALUE 'N'.
      ...
      *----------------------------------------------------------------*
       ...
       77  WRK-0480-TAM-CHAVE          PIC  9(002)         VALUE 2.
       77  WRK-0480-NOME-TABELA        PIC  X(008)         VALUE
           'TABUFNAT'.
       77  WRK-0480-TAM-OCORRENC       PIC  9(003)         VALUE 2.
      ...
      *----------------------------------------------------------------*
       ...
       77  WRK-FS-TABELA               PIC  X(02)          VALUE SPACES.
      ...
      *---------------------------------------------------------------* 
      *    AREA UTILIZADA PELO MODULO MESU9410 - FAIXA DE AGENCIAS    * 
      *---------------------------------------------------------------* 
                                                                        
       77  WRK-MESU9410                PIC X(08) VALUE 'MESU9410'.      
                                                                        
       01  WRK-AREA-MESU9410.                                           
           03  WRK-MESU9410-ENTRADA.                                    
               05  WRK-MESU9410-BANCO  PIC  9(03) COMP-3 VALUE 237.     
               05  WRK-MESU9410-AGE    PIC S9(05) COMP-3 VALUE ZEROS.   
           03  WRK-MESU9410-SAIDA.                                      
               05  WRK-MESU9410-RETORN PIC  9(02) VALUE ZEROS.          
      ...
      *                                                                 
           ...
           IF WRK-TABELA-VAZIA EQUAL 'N'
               PERFORM 2500-CARREGAR-TABELA
               MOVE 'S' TO WRK-TABELA-CARREGADA
           END-IF
      ...
      *----------------------------------------------------------------*
       1130-TESTAR-FS-TABELA         SECTION.
      *----------------------------------------------------------------*

           IF  WRK-FS-TABELA           NOT EQUAL ZEROS
               MOVE 'TABELA  '         TO FRWKGARQ-NOME-ARQUIVO
               MOVE WRK-FS-TABELA      TO FRWKGARQ-FILE-STATUS
               SET   WRK-ABENDAR       TO  TRUE
               PERFORM 9000-ERRO-ARQ
           END-IF.
      ...
      *----------------------------------------------------------------*
           ...
           IF  WRK-FS-TABELA         EQUAL '10'
               ...
               DISPLAY '*                                 *'            
               DISPLAY '******** PROGRAMA CLLP7955 ********'            
               MOVE 'S' TO WRK-TABELA-VAZIA
           ELSE
               MOVE 'N' TO WRK-TABELA-VAZIA
           END-IF.                                                      
      ...
      *----------------------------------------------------------------*
       2500-CARREGAR-TABELA          SECTION.
      *----------------------------------------------------------------*

           PERFORM 2600-MONTAR-TABELA
           ...
           IF  RETURN-CODE             NOT EQUAL ZEROS
               ...
               MOVE  RETURN-CODE       TO  FRWKGMOD-COD-RETORNO
               MOVE  ZEROS             TO  RETURN-CODE
               MOVE  01                TO  FRWKGMOD-COD-ERRO
               MOVE  'BRAD0450'        TO  FRWKGMOD-COD-MENSAGEM
      ...
      *----------------------------------------------------------------*
       2600-MONTAR-TABELA            SECTION.
      *----------------------------------------------------------------*

           MOVE PART-CSGL-UF           TO WRK-0480-UF.
      ...
      *----------------------------------------------------------------*
           ...
           PERFORM 1130-TESTAR-FS-TABELA.

           IF  WRK-FS-TABELA           EQUAL '00'
      ...
      *----------------------------------------------------------------*
           ...
           PERFORM 3010-VERIFICA-UF.

           IF WRK-TABELA-CARREGADA EQUAL 'S'
               IF WRK-UF-PARTICIPANTE EQUAL 'S'
      ...
      *----------------------------------------------------------------*
      * VERIFICA SE A UF EH PARTICIPANTE DA LEI DA TRANSPARENCIA
      *----------------------------------------------------------------*
       3010-VERIFICA-UF                SECTION.
      *----------------------------------------------------------------*

           MOVE AVI-UF                 TO WRK-0480-UF.
           ...
           IF  RETURN-CODE             NOT EQUAL ZEROS AND 12
               ...
               MOVE  RETURN-CODE       TO  FRWKGMOD-COD-RETORNO
               MOVE  ZEROS             TO  RETURN-CODE
               MOVE  03                TO  FRWKGMOD-COD-ERRO
               MOVE  'BRAD0450'        TO  FRWKGMOD-COD-MENSAGEM
               PERFORM 9100-ERRO-MODULO
           END-IF.

           IF  RETURN-CODE             EQUAL ZEROS
      *        REGISTRO ENCONTRADO NA TABELA
               MOVE 'S'                TO WRK-UF-PARTICIPANTE
           ELSE
      *        REGISTRO NAO ENCONTRADO NA TABELA
               MOVE 'N'                TO WRK-UF-PARTICIPANTE
           END-IF.
      ...
      *    BOOK RECRW810                                                
           ...
           MOVE  AVI-DATA-MVTO         TO  WRK-DATA-DDMMAAAA            
      ...
      *                                                                #
           ...
           MOVE  AVI-CGC-AVAL          TO  WRK-ID-CPF-CNPJ-NRO          
           MOVE  AVI-FIL-AVAL          TO  WRK-ID-CPF-CNPJ-FIL          
           MOVE  AVI-CTR-AVAL          TO  WRK-ID-CPF-CNPJ-CTR          
      ...
      *#################################################################
           ...
           DISPLAY 'ECORW392-NOME-CLIENTE ' ECORW392-NOME-CLIENTE       
           DISPLAY 'AVI-NOME-AVAL         ' AVI-NOME-AVAL               
      ...
      *#################################################################
           ...
           MOVE AVI-AGENCIA            TO UORGWB39-E-CUND-ORGNZ         
                                          WRK-MESU9410-AGE              
                                                                        
           PERFORM 3220-ACESSAR-MESU9410                                
                                                                        
           EVALUATE WRK-MESU9410-RETORN                                 
               WHEN ZEROS                                               
                   MOVE 15             TO UORGWB39-E-CTPO-UND-ORGNZ     
                   PERFORM 3210-ACESSAR-UORG2340                        
                   MOVE UORGWB39-S-NSEQ-ORG                             
                                       TO ECORW392-NSEQ-UND-ORGNZ-REM   
               WHEN 1                                                   
               ...
               WHEN 20                                                  
                   MOVE 21             TO UORGWB39-E-CTPO-UND-ORGNZ     
                   PERFORM 3210-ACESSAR-UORG2340                        
                   MOVE UORGWB39-S-NSEQ-ORG                             
                                       TO ECORW392-NSEQ-UND-ORGNZ-REM   
                                                                        
               WHEN OTHER                                               
                   MOVE ZEROS          TO ECORW392-NSEQ-UND-ORGNZ-REM   
           END-EVALUATE                                                 
      ...
      *----------------------------------------------------------------*
      * VERIFICAR SE OS CAMPOS DA TRANSPARENCIA ESTAO ZERADOS          *
      *----------------------------------------------------------------*
       3104-VERIFICAR-LT-ZERADOS    SECTION.
      *----------------------------------------------------------------*

           IF      AVI-VR-REMUNERATORIO(WRK-IND-DICD) EQUAL ZEROS
               AND AVI-VALOR-MORATORIO(WRK-IND-DICD)  EQUAL ZEROS
               AND AVI-VALOR-MULTA(WRK-IND-DICD)      EQUAL ZEROS
               AND AVI-DESP-JUD-CUSTAS(WRK-IND-DICD)  EQUAL ZEROS
               AND AVI-HONORARIOS(WRK-IND-DICD)       EQUAL ZEROS
               AND AVI-VL-TAXA-TARIFA(WRK-IND-DICD)   EQUAL ZEROS

               MOVE 'S'                TO WRK-LEILT-ZERADOS
               MOVE ZEROS              TO AVI-RESGATE(WRK-IND-DICD)
               MOVE ZEROS              TO AVI-IOF-NORMAL(WRK-IND-DICD)
           ELSE
               MOVE 'N'                TO WRK-LEILT-ZERADOS
           END-IF.
      ...
      *#################################################################
           ...
           IF AVI-DATA-MVTO NOT EQUAL ZEROS                             
               STRING AVI-DATA-MVTO(1:2) '.'                            
                   AVI-DATA-MVTO(3:2) '.'                               
                   AVI-DATA-MVTO(5:4)                                   
           ...
           PERFORM UNTIL AVI-NATUREZA(WRK-IND-DICD) EQUAL SPACES OR     
               ...
               PERFORM 3104-VERIFICAR-LT-ZERADOS
      ...
      *#################################################################
               ...
               IF AVI-NATUREZA(WRK-IND-DICD)         NOT EQUAL 'AR'     
                   MOVE WRK-EMPRESA-BRADESCO TO RECRW810-IMPRIME-EMPRESA
               ELSE                                                     
                   MOVE WRK-EMPRESA-LEASING  TO RECRW810-IMPRIME-EMPRESA
               END-IF                                                   
      ...
      *#################################################################
               ...
               IF AVI-NATUREZA(WRK-IND-DICD)         NOT EQUAL 'AR'     
                   MOVE WRK-EMPRESA-BRADESCO TO RECRW820-IMPRIME-EMPRESA
               ELSE                                                     
                   MOVE WRK-EMPRESA-LEASING  TO RECRW820-IMPRIME-EMPRESA
               END-IF                                                   
      ...
      *#################################################################
               ...
               IF AVI-NATUREZA(WRK-IND-DICD)         NOT EQUAL 'AR'     
                   MOVE WRK-EMPRESA-BRADESCO TO RECRW830-IMPRIME-EMPRESA
               ELSE                                                     
                   MOVE WRK-EMPRESA-LEASING  TO RECRW830-IMPRIME-EMPRESA
               END-IF                                                   
      ...
      *#################################################################
               ...
               IF AVI-NATUREZA(WRK-IND-DICD)         NOT EQUAL 'AR'     
                   MOVE WRK-EMPRESA-BRADESCO TO RECRW840-IMPRIME-EMPRESA
               ELSE                                                     
                   MOVE WRK-EMPRESA-LEASING  TO RECRW840-IMPRIME-EMPRESA
               END-IF                                                   
               IF AVI-POSSIBILIT(WRK-IND-DICD)           EQUAL '*'      
      ...
      *----------------------------------------------------------------*
       3220-ACESSAR-MESU9410           SECTION.                         
      *----------------------------------------------------------------*
                                                                        
           CALL WRK-MESU9410           USING WRK-AREA-MESU9410.         
                                                                        
           IF WRK-MESU9410-RETORN      EQUAL 99                         
              DISPLAY '********** CLLP2955 ***********'                 
              DISPLAY '*   ERRO NO MODULO MESU9410   *'                 
              DISPLAY '*     PROGRAMA CANCELADO      *'                 
              DISPLAY '********** CLLP2955 ***********'                 
               MOVE  WRK-PROGRAMA      TO  FRWKGMOD-NOME-MODULO         
               MOVE  WRK-MESU9410-RETORN                                
                                       TO  FRWKGMOD-COD-RETORNO         
               MOVE  '9410'            TO  FRWKGMOD-COD-ERRO            
               PERFORM 9100-ERRO-MODULO                                 
           END-IF.                                                      
...
PEREGO     END-IF.                                                      
           ...
           IF (ACU-LIDOS-EMODLAVS      GREATER ZEROS) AND               
              ...
              (ACU-ACESSOS-ECOR        GREATER ZEROS)                   
               DISPLAY '************* PROGRAMA CLLP7955 *************'  
               DISPLAY '*                                           *'  
               DISPLAY '*  PROGRAMA CLLP7955 ENCERRADO COM SUCESSO  *'  
               DISPLAY '*                                           *'  
               DISPLAY '************* PROGRAMA CLLP7955 *************'  
           END-IF.                                                      
      ...
      *----------------------------------------------------------------*
           ...
           IF  CK01-RESTART                                             
               DISPLAY 'CLLP7955 - PROCESSAMENTO COM RESTART'           
           ...
           ELSE                                                         
               DISPLAY 'CLLP7955 - PROCESSAMENTO NORMAL (SEM RESTART)'  
           END-IF.                                                      
