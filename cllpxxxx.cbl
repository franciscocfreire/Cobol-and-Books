...
@BRQ=E*    MOVE AVI-DESCRIC (WRK-IND1)    TO LD2A-DESCRIC  (WRK-IND1).
@BRQ=I     MOVE SPACES                    TO LD2A-DESCRIC  (WRK-IND1).
...
BSI                 0000-GRAVA-ARQCEDD-FIM.
      ...
      *--- LINHA 1 ---*
           ...
           MOVE    AVI-NOME-AVAL     TO    LD1B-NOME-RES
           MOVE    AVI-NUM-CC        TO    LD1B-CONTA
           MOVE    '-'               TO    LD1B-HIFEN
      ...
      *--- LINHA 4 ---*
           ...
           MOVE  AVI-MUNIC-AGENCIA TO      LD4B-CID-AGE
...
ELA        MOVE  WRK-ANO-SIST    TO      LD4B-ANO
      ...
      *--- LINHA 5 ---*
           ...
           MOVE AVI-NOME-AGENCIA  TO      LD5B-NOME-AGE
           MOVE AVI-END-AGENCIA TO      LD5B-ENDER-AGE
           MOVE AVI-MUNIC-AGENCIA TO      LD5B-CID-AGE.
...
@BRQ=E*    MOVE WRK-DESCRIC  (WRK-IND1)   TO LD2B-DESCRIC  (WRK-IND1).
@BRQ=I     MOVE SPACES                    TO LD2B-DESCRIC  (WRK-IND1).
      ...
      *---------------------------------------------------------------*
       0000-MONT-EXT-LD2          SECTION.
           ...
           MOVE    AVI-AGENCIA       TO    CB3B-AGEN.
           MOVE    '-'               TO    CB3B-HIFEN.
           MOVE    '/'               TO    CB3B-BARRA.
           MOVE    AVI-NOME-AGENCIA  TO    CB3B-NOME-AG.
           ...
           MOVE    AVI-NOME-AVAL     TO    CB4B-NOME-RES
           ...
           MOVE    AVI-COMPL         TO    WRKB-COM-RES
           MOVE    AVI-BAIRRO        TO    WRKB-BAI-RES

           MOVE    AVI-CCEP          TO    WRKB-CEP
           MOVE    '-'               TO    WRKB-HIFEN
           MOVE    AVI-CCEP-COMPL    TO    WRKB-CEP-SUFIXO

           MOVE  SPACES              TO    WRKB-CIDADE
           STRING AVI-CIDADE  '-' AVI-UF
           DELIMITED BY '  ' INTO WRKB-CIDADE

           MOVE    AVI-SEQUENCIAL       TO    CB3B-NRO-SEQ
      ...
      *---------------------------------------------------------------*
       0000-CARTA-CORREIO-B       SECTION.
           ...
           MOVE    AVI-END-AGENCIA       TO    CB1B-END-AG.
           MOVE   SPACES             TO    CB1B-ECT.
           MOVE    AVI-CEP-AGENCIA   TO    WRK-TRATA-CEP-R.
           MOVE    WRK-TR-CEP        TO    CB2B-CEP.
           MOVE   '-'                TO    CB2B-HIFEN.
           MOVE    WRK-TR-CEP-SUF    TO    CB2B-AG-SUFIXO.
           MOVE    AVI-MUNIC-AGENCIA TO    CB2B-MUNICIPIO.
           MOVE    AVI-SIGLA-AGENCIA TO    CB2B-SIGLA.
...
BSI                 0000-GRAVA-ARQCEDD-FIM.
      ...
      *---------------------------------------------------------------*
       0000-CARTA-AGENCIA-B       SECTION.
           ...
           MOVE    'CD'            TO    CBCD2-CD.
           MOVE    AVI-CD-AGENCIA  TO    CBCD2-NRO-CD.
