      ...
      *                                                                #
           ...
           MOVE  SPC-PRINCIPAL         TO  WRK-ID-CPF-CNPJ-NRO          
           MOVE  SPC-FILIAL            TO  WRK-ID-CPF-CNPJ-FIL          
           MOVE  SPC-CONTROLE          TO  WRK-ID-CPF-CNPJ-CTR          
      ...
      *----------------------------------------------------------------*
           ...
           IF      SPC-VR-REMUNERATORIO(WRK-IND-DICD) EQUAL ZEROS
               AND SPC-VALOR-MORATORIO(WRK-IND-DICD)  EQUAL ZEROS
               AND SPC-VALOR-MULTA(WRK-IND-DICD)      EQUAL ZEROS
               AND SPC-DESP-JUD-CUSTAS(WRK-IND-DICD)  EQUAL ZEROS
               AND SPC-HONORARIOS(WRK-IND-DICD)       EQUAL ZEROS
               AND SPC-VL-TAXA-TARIFA(WRK-IND-DICD)   EQUAL ZEROS

               MOVE 'S'                TO WRK-LEILT-ZERADOS
               MOVE ZEROS              TO SPC-RESGATE(WRK-IND-DICD)
               MOVE ZEROS              TO SPC-IOF-NORMAL(WRK-IND-DICD)
           ELSE
