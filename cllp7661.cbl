      ...
      *----------------------------------------------------------------*
       ...
       01  FD-DB2-REGTO.                                                
           03  FD-DB2-CHAVE.                                            
               05  FD-DB2-CPF-DEV.                                      
                07 FD-DB2-NUMERO-DEV       PIC 9(09)    COMP-3.         
                07 FD-DB2-FILIAL           PIC 9(05)    COMP-3.         
                07 FD-DB2-CTR-DEV          PIC 9(02).                   
               05  FD-DB2-COD-NATUREZA-OPER PIC X(03).                  
               05  FD-DB2-CONTRATO         PIC 9(07)    COMP-3.         
           03  FD-DB2-VCTO                 PIC 9(08).                   
           03  FD-DB2-EMPRESA              PIC 9(05)    COMP-3.         
           03  FD-DB2-AGENCIA              PIC 9(05)    COMP-3.         
           03  FD-DB2-CONTA                PIC 9(07)    COMP-3.         
           03  FD-DB2-CARTEIRA             PIC X(03).                   
           03  FD-DB2-ID                   PIC X(02).                   
           03  FD-DB2-MOEDA                PIC X(02).                   
           03  FD-DB2-TIPO-PEND            PIC 9(05)    COMP-3.         
           03  FD-DB2-CODIGO               PIC 9(03)    COMP-3.         
           03  FD-DB2-PRINCIPAL            PIC 9(13)V99 COMP-3.         
           03  FD-DB2-VR-VENCIDOS          PIC 9(13)V99 COMP-3.         
           03  FD-DB2-VR-VINCENDOS         PIC 9(13)V99 COMP-3.         
           03  FD-DB2-NOME-DEVEDOR.                                     
               05  FD-DB2-NOME-20          PIC X(20).                   
               05  FILLER                  PIC X(20).                   
           03  FD-DB2-NOME-AVALISTA        PIC X(40).                   
           03  FD-DB2-CPF-AVAL.                                         
               05  FD-DB2-NUMERO-AVAL      PIC 9(09)    COMP-3.         
               05  FD-DB2-FILIAL-AVAL      PIC 9(05)    COMP-3.         
               05  FD-DB2-CTR-AVAL         PIC 9(02).                   
           03  FD-DB2-NOME-AVAL2           PIC X(40).                   
           03  FD-DB2-CPF-AVAL2.                                        
               05  FD-DB2-NUMERO-AVAL2     PIC 9(09)    COMP-3.         
               05  FD-DB2-FILIAL-AVAL2     PIC 9(05)    COMP-3.         
               05  FD-DB2-CTR-AVAL2        PIC 9(02).                   
           03  FD-DB2-COD-EMPR             PIC 9(02).
           03  FILLER                      PIC X(100).
      ...
      *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *
       77  FILLER   PIC  X(32) VALUE '*  INICIO DA WORKING CLLP7661  *'.
      *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *
      ...
      *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *
       ...
       01  WRK-CONTRATO-AUX-R    REDEFINES  WRK-FIL-AVI-AUX.            
           03  FILLER                  PIC  9(01).                      
       ...
       01  WRK-VENCIMENTO            PIC  9(08) VALUE ZEROS.            
       01  FILLER              REDEFINES  WRK-VENCIMENTO.               
           03  WRK-ANO               PIC  9(04).                        
           03  WRK-MES               PIC  9(02).                        
           03  WRK-DIA               PIC  9(02).                        
                                                                        
       01  WRK-VENCIMENTO-AUX.                                          
      ...
      *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *
       ...
       01  CABEC1.                                                      
           ...
           03  FILLER                  PIC X(008)      VALUE 'CLLP7661'.
      ...
      *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *
       01  FILLER   PIC  X(32) VALUE '*   FIM DA WORKING CLLP7661    *'.
      *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *
      ...
      *----------------------------------------------------------------*
           ...
           WRITE FD-AVINMIGR     FROM FD-DB2-REGTO.                     
      ...
      *----------------------------------------------------------------*
           ...
           WRITE FD-AVIMIGR          FROM FD-DB2-REGTO.                 
      ...
      *----------------------------------------------------------------*
           ...
           MOVE    FD-DB2-AGENCIA      TO WRK-AG-AVISO.                 
           MOVE    FD-DB2-CONTA        TO WRK-CC-AVISO.                 
           MOVE    FD-DB2-CARTEIRA     TO WRK-CART-AVISO.               
           MOVE    FD-DB2-CONTRATO     TO WRK-CONTR-AVISO.              
      ...
      *----------------------------------------------------------------*
           ...
           MOVE FD-DB2-NUMERO-DEV        TO LDT-CPF1.                   
           MOVE FD-DB2-FILIAL            TO LDT-FILIAL1.                
           MOVE FD-DB2-CTR-DEV           TO LDT-DIG1.                   
           MOVE FD-DB2-AGENCIA           TO WRK-AGENCIA-AUX.            
           MOVE WRK-AGENCIA-AUX-RR       TO LDT-AGENCIA1.               
           MOVE FD-DB2-CONTA             TO WRK-CONTA-AUX.              
           MOVE WRK-CONTA-AUX-RR         TO LDT-CONTA1.                 
           MOVE FD-DB2-CARTEIRA          TO LDT-CARTEIRA1.              
           MOVE FD-DB2-CONTRATO          TO WRK-CONTRATO-AUX1.          
           MOVE WRK-CONTRATO-AUX1-RR     TO LDT-CONTRATO1.              
           MOVE FD-DB2-VCTO              TO WRK-VENCIMENTO.             
           MOVE WRK-DIA                  TO WRK-DIA-AUX.                
           MOVE WRK-MES                  TO WRK-MES-AUX.                
           MOVE WRK-ANO                  TO WRK-ANO-AUX.                
           MOVE WRK-VENCIMENTO-AUX       TO LDT-DATA-VENCIMENTO1.       
      ...
      *    EVITAR ESTOURO DO RELATORIO                                  
           ...
           MOVE FD-DB2-NUMERO-DEV        TO LDT-CPF.                    
           MOVE FD-DB2-FILIAL            TO LDT-FILIAL.                 
           MOVE FD-DB2-CTR-DEV           TO LDT-DIG.                    
           MOVE FD-DB2-AGENCIA           TO WRK-AGENCIA-AUX.            
           MOVE WRK-AGENCIA-AUX-RR       TO LDT-AGENCIA.                
           MOVE FD-DB2-CONTA             TO WRK-CONTA-AUX.              
           MOVE WRK-CONTA-AUX-RR         TO LDT-CONTA.                  
           MOVE FD-DB2-CARTEIRA          TO LDT-CARTEIRA.               
           MOVE FD-DB2-CONTRATO          TO WRK-CONTRATO-AUX1.          
           ...
           MOVE WRK-MES                  TO WRK-MES-AUX.                
           MOVE WRK-ANO                  TO WRK-ANO-AUX.                
           MOVE WRK-VENCIMENTO-AUX       TO LDT-DATA-VENCIMENTO.        
      ...
      *----------------------------------------------------------------*
           ...
           MOVE    ACU-REGISTROS-MIGRADOS TO  WRK-GRAVA1.               
                                                                        
           DISPLAY '***************** CLLP7661 *******************'.    
           DISPLAY '* LIDOS MOVTO DE AVISOS  : ' WRK-L-ENT '     *'.    
           DISPLAY '* LIDOS MOVTO MIGRADOS   : ' WRK-L-SEG '     *'.    
           DISPLAY '* CONTINUAM NO PROCESSO  : ' WRK-GRAVA '     *'.    
           DISPLAY '* RETIRADOS DO PROCESSO  : ' WRK-GRAVA1'     *'.    
           DISPLAY '***************** CLLP7661 *******************'.    
