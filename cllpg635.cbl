...
SID    PROCEDURE DIVISION        USING       LNK-CAMPOS-PARM.
      ...
      *---------------------------------------------------------------*
       0000-MONT-INT-LD1          SECTION.
           ...
           MOVE    AVI-AGENCIA       TO    LD2A-AGENCIA
           MOVE    ' - '             TO    LD2A-HIFEN
           MOVE    AVI-NOME-AGENCIA      TO    LD2A-NOME-AGE

           MOVE    AVI-NUM-CC         TO    LD3A-CONTA
           MOVE    '-'               TO    LD3A-HIFEN

           MOVE    '7'               TO    WRK-DIGITO
           MOVE     4                TO    WRK-TAMANHO
           CALL    'POOL0431'     USING    AVI-NUM-CC
                                           WRK-DIGITO
                                           WRK-TAMANHO
      ...
      *---------------------------------------------------------------*
       0000-SORT-A1               SECTION.
           ...
           IF WRK-IND2   GREATER  11
              NEXT SENTENCE
           ELSE
              IF AVI-DAT-VENCTO(WRK-IND1) LESS AVI-DAT-VENCTO(WRK-IND2)
      ...
      *---------------------------------------------------------------*
       0000-CARRE-DET-A           SECTION.
           ...
           MOVE AVI-NATUREZA (WRK-IND1)   TO LD4A-COD-NAT  (WRK-IND1).
           ...
           END-EVALUATE.
           MOVE WRK-DESCRIC               TO LD4A-DESCRIC  (WRK-IND1).
           ...
           MOVE AVI-RESGATE    (WRK-IND1)   TO LD5A-VALOR    (WRK-IND1).
           ...
           MOVE    AVI-SEQUENCIAL            TO  LD8A-NRO-SEQ.
      ...
      *---------------------------------------------------------------*
       0000-MONT-EXT-LD1          SECTION.
           ...
           CALL  'POOL0431'       USING    AVI-AGENCIA
                                           WRK-DIGITO
                                           WRK-TAMANHO.
           IF WRK-DIGITO  EQUAL  'P'
...
SAN        MOVE    SPACES            TO    CB1A-LADO1.
      ...
      *---------------------------------------------------------------*
       0000-CARRE-DET-B1          SECTION.
           ...
           MOVE AVI-NATUREZA (WRK-IND1)   TO LD4B-COD-NAT  (WRK-IND1).
           ...
           MOVE WRK-DESCRIC     TO LD4B-DESCRIC  (WRK-IND1).
           ...
           MOVE AVI-RESGATE    (WRK-IND1)   TO LD5B-VALOR    (WRK-IND1).
           ...
           MOVE    AVI-SEQUENCIAL            TO  LD8B-NRO-SEQ.
