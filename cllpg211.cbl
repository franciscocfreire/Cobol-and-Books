...
BRQ141******************************************************************
      ...
      *---------------------------------------------------------------* 
       ...
       77  ACU-VR-REMUNERATORIO        PIC  9(13)V99     VALUE ZEROS.   
       77  ACU-VALOR-MORATORIO         PIC  9(13)V99     VALUE ZEROS.   
       77  ACU-VALOR-MULTA             PIC  9(13)V99     VALUE ZEROS.   
       77  ACU-DESP-JUD-CUSTAS         PIC  9(11)V99     VALUE ZEROS.   
       77  ACU-HONORARIOS              PIC  9(11)V99     VALUE ZEROS.   
       77  ACU-VL-TOTAL-DIVIDA         PIC  9(15)V99     VALUE ZEROS.   
       77  ACU-VL-TAXA-TARIFA          PIC  9(15)V99     VALUE ZEROS.   
       ...
       01  WRK-CH-ARQLPCL-ATU.                                          
           ...
           03  WRK-CONTRATO-ATU        PIC 9(07)   COMP-3.
       ...
       01  WRK-CH-ARQLPCL-ANT.                                          
           ...
           02  WRK-CONTRATO-ANT        PIC 9(07)   COMP-3.
      ...
      *---------------------------------------------------------------* 
       ...
       01  CABEC1.                                                      
           ...
           03  FILLER                  PIC X(28) VALUE 'CLLPG211'.      
...
SID    PROCEDURE      DIVISION      USING       LNK-CAMPOS-PARM.        
      ...
      *---------------------------------------------------------------* 
           ...
           MOVE  CGCCPF-NUM-WOR OF ARQLPCL    TO   WRK-CPF-NUM-ATU.     
           MOVE  CGCCPF-FIL-WOR OF ARQLPCL    TO   WRK-CPF-FIL-ATU.     
           MOVE  CGCCPF-CTR-WOR OF ARQLPCL    TO   WRK-CPF-CTR-ATU.     
           MOVE  CAD-NCGC1-WOR  OF ARQLPCL    TO   WRK-CPF-NUM-AVA-ATU. 
           MOVE  CAD-FIL1-WOR OF ARQLPCL      TO   WRK-CPF-FIL-AVA-ATU. 
           MOVE  CAD-CTR1-WOR OF ARQLPCL      TO   WRK-CPF-CTR-AVA-ATU. 
           MOVE  NATUREZA-WOR OF ARQLPCL      TO   WRK-NATUREZA-ATU.    
           MOVE  AGENCIA-WOR  OF ARQLPCL      TO   WRK-AGENCIA-ATU.     
           MOVE  CONTA-WOR  OF ARQLPCL        TO   WRK-CONTA-ATU.       
                                                                        
           MOVE  CONTRATO-WOR   OF ARQLPCL   TO   WRK-CONTRATO-ATU.     
      ...
      *---------------------------------------------------------------* 
           ...
           MOVE  REG-WOR-EXP OF ARQLPCL TO REG-WOR-EXP OF CADLPCL       
           ...
           MOVE  ACU-VAL-RESG      TO   VAL-RESG-WOR OF CADLPCL         
           MOVE  ACU-ENC-VENC      TO   VAL-ENC-VEN-WOR OF CADLPCL      
           MOVE  ACU-ENC-VINC      TO   VAL-ENC-VIN-WOR OF CADLPCL.     
           MOVE ACU-VR-REMUNERATORIO TO WOR-VR-REMUNERATORIO OF CADLPCL.
           MOVE  ACU-VALOR-MORATORIO  TO WOR-VALOR-MORATORIO OF CADLPCL.
           MOVE  ACU-VALOR-MULTA      TO WOR-VALOR-MULTA     OF CADLPCL.
           MOVE  ACU-DESP-JUD-CUSTAS  TO WOR-DESP-JUD-CUSTAS OF CADLPCL.
           MOVE  ACU-HONORARIOS       TO WOR-HONORARIOS      OF CADLPCL.
           MOVE  ACU-VL-TOTAL-DIVIDA  TO WOR-VL-TOTAL-DIVIDA OF CADLPCL.
           MOVE  ACU-VL-TAXA-TARIFA   TO WOR-VL-TAXA-TARIFA  OF CADLPCL.
      *---------------------------------------------------------------* 
       3200-99-FIM.                    EXIT.                            
      *---------------------------------------------------------------* 
           EJECT                                                        
      ...
      *---------------------------------------------------------------* 
           ...
           ADD  VAL-RESG-WOR OF ARQLPCL           TO   ACU-VAL-RESG.    
           ADD  VAL-ENC-VEN-WOR OF ARQLPCL        TO   ACU-ENC-VENC.    
           ADD  VAL-ENC-VIN-WOR OF ARQLPCL        TO   ACU-ENC-VINC.    
           ADD  WOR-VR-REMUNERATORIO OF ARQLPCL TO ACU-VR-REMUNERATORIO.
           ADD  WOR-VALOR-MORATORIO  OF ARQLPCL TO ACU-VALOR-MORATORIO. 
           ADD  WOR-VALOR-MULTA      OF ARQLPCL TO ACU-VALOR-MULTA.     
           ADD  WOR-DESP-JUD-CUSTAS  OF ARQLPCL TO ACU-DESP-JUD-CUSTAS. 
           ADD  WOR-HONORARIOS       OF ARQLPCL TO ACU-HONORARIOS.      
           ADD  WOR-VL-TOTAL-DIVIDA  OF ARQLPCL TO ACU-VL-TOTAL-DIVIDA. 
           ADD  WOR-VL-TAXA-TARIFA   OF ARQLPCL TO ACU-VL-TAXA-TARIFA.  
