      ******************************************************************
      * DCLGEN TABLE(DB2PRD.TREG_COMPR_RECTA)                          *
      *        LIBRARY(AD.DB2.DCLGEN(SCSBB013))                        *
      *        ACTION(REPLACE)                                         *
      *        LANGUAGE(COBOL)                                         *
      *        STRUCTURE(SCSBB013)                                     *
      *        APOST                                                   *
      ...
      ******************************************************************
           EXEC SQL DECLARE DB2PRD.TREG_COMPR_RECTA TABLE               
           ( DANO_COMPR_RECTA               DECIMAL(4, 0) NOT NULL,     
             NREG_COMPR_RECTA               DECIMAL(9, 0) NOT NULL,     
             CPSSOA_UND_ORGNZ               DECIMAL(10, 0) NOT NULL,    
             NSEQ_UND_ORGNZ                 DECIMAL(8, 0) NOT NULL,     
             CPSSOA_JURID                   DECIMAL(10, 0) NOT NULL,    
             IVDDOR_EXTER                   CHAR(150) NOT NULL,         
             EEXTER_VDDOR                   CHAR(150) NOT NULL,         
      ...
      ******************************************************************
      * COBOL DECLARATION FOR TABLE DB2PRD.TREG_COMPR_RECTA            *
      ******************************************************************
       01  SCSBB013.                                                    
      *    *************************************************************
           10 DANO-COMPR-RECTA     PIC S9(4)V USAGE COMP-3.             
      *    *************************************************************
           10 NREG-COMPR-RECTA     PIC S9(9)V USAGE COMP-3.             
      *    *************************************************************
      ...
      *    *************************************************************
           10 IVDDOR-EXTER         PIC X(150).                          
      *    *************************************************************
           10 EEXTER-VDDOR         PIC X(150).                          
      *    *************************************************************
