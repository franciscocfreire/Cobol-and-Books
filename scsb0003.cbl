      ...
      *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *
       01  FILLER PIC X(34) VALUE  '** INICIO DA WORKING SCSB0003 **  '.
      *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *
      ...
      *
       ...
       01  WRK-LIT-PGM                 PIC  X(008)  VALUE 'SCSB0003'.
      ...
      *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *
       01  FILLER PIC X(34) VALUE  '** FIM DA WORKING SCSB0003 **     '.
      *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *
           ...
           PERFORM VARYING WRK-POSICAO FROM 1 BY 1
                     ...
                     IF(WRK-CHAR EQUAL '!' OR WRK-CHAR EQUAL '@'
                      ...
                      OR  WRK-CHAR EQUAL '/' OR  WRK-CHAR EQUAL '+')
                       ...
                       DISPLAY 'CHAR INVALIDO: ' WRK-CHAR
                     ...
                     IF WRK-SPACES-DUPLO NOT EQUAL ZEROS AND
                       ...
                       DISPLAY 'ESPACO DUPLO'
                       DISPLAY 'CHAR ESPACO DUPLO: ' WRK-CHAR
                       MOVE 007            TO  WRK-ERRO-OCORRIDO
                       PERFORM 3101-ADICIONA-ERRO
                       GO TO 8000-FIM
                     END-IF
