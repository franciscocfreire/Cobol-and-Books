      ...
      *                 DADOS DO PRV PJ DO RDAB.                      * 
      *   ARQUIVOS:                                                   * 
      *   ---------------------------------------------------------   * 
      *   DDNAME   |I/O| DESCRICAO               | BOOK     | LRECL   * 
      *   ---------+---+-------------------------+----------+------   * 
      *   NOMECADU | I | DADOS PJ CADU           | WORKING  |   130   * 
      *   NOMERDAB | I | DADOS PJ RDAB           | WORKING  |   081   * 
      *   CADURDAB | O | DADOS PJ CADU + RDAB    | WORKING  |   081   * 
      *   ATULZPJ  | O | ATUALIZADOS PJ          | WORKING  |   081   * 
      *   DESPRDAB | O | DESPR.PJ CADU + RDAB    | WORKING  |   130   * 
      *   ---------------------------------------------------------   * 
      ...
      *---------------------------------------------------------------* 
       ...
       FILE-CONTROL.                                                    
           ...
           SELECT  ATULZPJ   ASSIGN  TO  UT-S-ATULZPJ                   
                   FILE      STATUS  IS  WRK-FS-ATULZPJ.                
      ...
      *---------------------------------------------------------------* 
       ...
       01  FILLER.                                                      
           ...
           03  WRK-FS-ATULZPJ          PIC  X(02) VALUE SPACES.         
      ...
      *--  ACUMULADORES.                                                
       ...
       01  FILLER.                                                      
           ...
           03  ACU-GRV-ATULZPJ         PIC 9(09) COMP-3    VALUE  ZEROS.
      ...
      *--  CHAVE AUXILIAR                                               
       01  WRK-TEMP-NOMERDAB.                                           
          ...
          03  WRK-AUX-RDAB-CPF          REDEFINES WRK-TEMP-RDAB-CPF     
                                        PIC  9(009).                    
          03  WRK-TEMP-RDAB-FILIAL      PIC S9(005) VALUE ZEROS.        
          03  WRK-AUX-RDAB-FILIAL       REDEFINES WRK-TEMP-RDAB-FILIAL  
                                        PIC  9(005).                    
      *----------------------------------------------------------------*
      ...
      *---------------------------------------------------------------* 
           ...
           PERFORM  1170-TESTAR-FS-ATULZPJ.                             
      *---------------------------------------------------------------* 
       1100-99-FIM.   EXIT.                                             
      *---------------------------------------------------------------* 
      ...
      *---------------------------------------------------------------* 
       1170-TESTAR-FS-ATULZPJ         SECTION.                          
      *---------------------------------------------------------------* 
           IF WRK-FS-ATULZPJ            NOT EQUAL  '00'                 
              DISPLAY '************** RDAB0271 *************'           
              DISPLAY '*   ERRO ' WRK-OPERACAO  ' DO ARQUIVO   *'       
              DISPLAY '*              ATULZPJ               *'          
              DISPLAY '*         FILE STATUS =  ' WRK-FS-ATULZPJ        
                                                 '         *'           
              DISPLAY '************** RDAB0271 *************'           
              PERFORM 9999-ROTINA-ERRO                                  
           END-IF.                                                      
      ...
      *---------------------------------------------------------------* 
           ...
           MOVE APJ-CBASE-CPF          TO  WRK-TEMP-RDAB-CPF            
           MOVE APJ-CFLIAL-CNPJ        TO  WRK-TEMP-RDAB-FILIAL         
                                                                        
           MOVE WRK-AUX-RDAB-CPF       TO  WRK-CHV-RDAB-CPF             
           MOVE WRK-AUX-RDAB-FILIAL    TO  WRK-CHV-RDAB-FILIAL          
      ...
      *---------------------------------------------------------------* 
           ...
           ELSE                                                         
              IF   WRK-CHV-NOMECADU   LESS    WRK-CHV-NOMERDAB          
                   ...
                   PERFORM 2000-LER-NOMECADU                            
              ELSE                                                      
                 IF  FD-REG-NOME-CADU  EQUAL  APJ-IPRIM-TTLAR-RENEG     
                 ...
                 ELSE                                                   
                    ...
                    ELSE                                                
                       MOVE  FD-REG-NOME-CADU                           
                                       TO  APJ-IPRIM-TTLAR-RENEG        
                       PERFORM 5200-GRAVAR-ATULZPJ                      
                       PERFORM 5000-GRAVAR-CADURDAB                     
                    END-IF                                              
                 END-IF                                                 
                 PERFORM 3000-LER-NOMERDAB                              
      ...
      *---------------------------------------------------------------* 
           WRITE  FD-REG-CADURDAB      FROM    APJ-REG                  
      ...
      *---------------------------------------------------------------* 
       5200-GRAVAR-ATULZPJ           SECTION.                           
      *---------------------------------------------------------------* 
           WRITE  FD-REG-ATULZPJ       FROM    APJ-REG                  
           MOVE   WRK-GRAVACAO         TO      WRK-OPERACAO             
           PERFORM  1170-TESTAR-FS-ATULZPJ                              
                                                                        
           ADD 1                      TO   ACU-GRV-ATULZPJ.             
      *---------------------------------------------------------------* 
       5200-99-FIM.   EXIT.                                             
      *---------------------------------------------------------------* 
