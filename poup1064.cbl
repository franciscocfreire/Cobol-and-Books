      ...
      *           |----------|---------|----------|-------|            *
      *           | MVTODIAE | INPUT   | I#POUPN0 |  140  |            *
      *           | ARQSALDO | INPUT   | I#POUPSL |  050  |            *
      *           | MVTODIAS | OUTPUT  | I#POUPN0 |  140  |            *
      *           +---------------------------------------+            *
      *                                                                *
      *    MODULOS :                                                   *
      *                                                                *
      ...
      *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *
       01  FILLER PIC X(34) VALUE  '** INICIO DA WORKING POUP1064 **  '.
      *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *
      ...
      *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *
       ...
       01  WRK-DLCTO-CREDT-ANT         PIC  9(8)           VALUE ZEROS. 
                                                                        
       01  WRK-DLCTO-CREDT-DIA         PIC  9(8)           VALUE ZEROS. 
      ...
      *                                                                 
       ...
       01  WRK-LIT-PGM                 PIC  X(008)  VALUE 'POUP1064'.   
      ...
      *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *
       01  FILLER PIC X(34) VALUE  '** FIM DA WORKING POUP1064 **     '.
      *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *
      ...
      *----------------------------------------------------------------*
           ...
           IF WRK-FS-MVTODIAE          EQUAL '10'                       
              ...
              DISPLAY '*                                    *'          
              DISPLAY '***================================***'          
              MOVE  'ARQUIVO MVTODIAE VAZIO' TO  ERR-TEXTO              
              MOVE  'APL'              TO  ERR-TIPO-ACESSO              
              PERFORM  9999-FINALIZAR-ERRO                              
           END-IF                                                       
      ...
      *----------------------------------------------------------------*
           ...
           READ MVTODIAE               INTO MOVSUBC                     
                                                                        
           IF WRK-FS-MVTODIAE          NOT EQUAL '10'                   
              PERFORM 1110-TESTAR-FS-MVTODIAE                           
              ADD   1                  TO  ACU-LIDOS-MVTODIAE           
              MOVE  MVSB-CJUNC-DEPDC   TO  WRK-CHV-MOV-AGE              
              MOVE  MVSB-CCTA-POUP     TO  WRK-CHV-MOV-CTA              
           ELSE                                                         
              MOVE  HIGH-VALUES        TO  WRK-CHV-MOVTO                
           END-IF.                                                      
                                                                        
           IF  ACU-LIDOS-MVTODIAE      EQUAL   ZEROS AND                
               WRK-FS-MVTODIAE         EQUAL   '10'                     
               GO TO 2100-99-FIM                                        
           END-IF.                                                      
      ...
      *----------------------------------------------------------------*
           ...
           IF POUPM4-COD-RETORNO       EQUAL   'M'                      
              ...
              MOVE WRK-AUX-TAM-05-R      TO  MVSB-CJUNC-DEPDC           
              MOVE POUPSL-CTA-PARA       TO  WRK-AUX-TAM-07             
              MOVE WRK-AUX-TAM-07-R      TO  MVSB-CCTA-POUP             
              PERFORM 3600-CALCULAR-DIGITO                              
              MOVE WRK-B0431-DIGITO      TO  MVSB-CDIG-CCTA             
                                                                        
              PERFORM 4000-GRAVAR-MVTODIAS                              
                                                                        
              MOVE  MVSB-VMOVTO          TO  WRK-VMOVTO                 
                                                                        
              IF MVSB-CDEB-CRED          EQUAL   2                      
      ...
      *----------------------------------------------------------------*
       3400-TRATAR-CREDITO             SECTION.                         
           ...
           MOVE MVSB-DLCTO-MOVTO       TO  WRK-DLCTO-CREDT-DIA          
                                                                        
           IF   MVSB-DLCTO-MOVTO   NOT EQUAL   WRK-DLCTO-CREDT-ANT      
                MOVE WRK-VMOVTO        TO  WRK-CREDT-DIA-MP             
                MOVE MVSB-DLCTO-MOVTO  TO  WRK-DLCTO-CREDT-ANT          
           ELSE                                                         
      ...
      *----------------------------------------------------------------*
       3500-TRATAR-DEBITO              SECTION.                         
           ...
           MOVE    MVSB-VMOVTO         TO  WRK-MOVTO-DEBITAR.           
                                                                        
           IF  (WRK-CREDT-DIA-MP       GREATER ZEROS) AND               
               (MVSB-DLCTO-MOVTO       EQUAL   WRK-DLCTO-CREDT-DIA)     
      ...
      *----------------------------------------------------------------*
       3510-DEBITAR-CREDITO-DIA        SECTION.                         
           ...
           IF  WRK-MOVTO-DEBITAR       GREATER WRK-CREDT-DIA-MP         
               MOVE    WRK-CREDT-DIA-MP TO MVSB-VMOVTO                  
               PERFORM 4000-GRAVAR-MVTODIAS                             
               MOVE    MVSB-VMOVTO     TO  WRK-VMOVTO                   
               COMPUTE WRK-MOVTO-DEBITAR=  WRK-MOVTO-DEBITAR -          
                                                              WRK-VMOVTO
               COMPUTE WRK-SLD-CTA-MP   =  WRK-SLD-CTA-MP    -          
                                                              WRK-VMOVTO
               MOVE    ZEROS           TO  WRK-CREDT-DIA-MP             
           ELSE                                                         
               PERFORM 4000-GRAVAR-MVTODIAS                             
       ...
       3520-DEBITAR-CONTA-ESTOQUE      SECTION.                         
           ...
           IF  WRK-MOVTO-DEBITAR       GREATER WRK-SLD-CTA-ESTOQUE      
            IF WRK-SLD-CTA-ESTOQUE  NOT EQUAL ZEROS                     
               ...
               PERFORM 3600-CALCULAR-DIGITO                             
               MOVE    WRK-B0431-DIGITO TO  MVSB-CDIG-CCTA              
               MOVE WRK-SLD-CTA-ESTOQUE TO  MVSB-VMOVTO                 
               PERFORM 4000-GRAVAR-MVTODIAS                             
            ELSE                                                        
               MOVE    ZEROS            TO  MVSB-VMOVTO                 
            END-IF                                                      
            MOVE    ZEROS               TO  WRK-SLD-CTA-ESTOQUE         
            MOVE    MVSB-VMOVTO         TO  WRK-VMOVTO                  
            COMPUTE WRK-MOVTO-DEBITAR =   WRK-MOVTO-DEBITAR - WRK-VMOVTO
            MOVE    WRK-MOVTO-DEBITAR   TO  MVSB-VMOVTO                 
            MOVE    POUPSL-AGE-PARA     TO  WRK-AUX-TAM-05              
            MOVE    WRK-AUX-TAM-05-R    TO  MVSB-CJUNC-DEPDC            
            MOVE    POUPSL-CTA-PARA     TO  WRK-AUX-TAM-07              
            MOVE    WRK-AUX-TAM-07-R    TO  MVSB-CCTA-POUP              
       ...
       3530-DEBITAR-CONTA-MP           SECTION.                         
           ...
           IF  WRK-MOVTO-DEBITAR       GREATER WRK-SLD-CTA-MP           
            IF WRK-SLD-CTA-MP      NOT EQUAL   ZEROS                    
               ...
               PERFORM 3600-CALCULAR-DIGITO                             
               MOVE    WRK-B0431-DIGITO TO MVSB-CDIG-CCTA               
               MOVE    WRK-SLD-CTA-MP  TO  MVSB-VMOVTO                  
               PERFORM 4000-GRAVAR-MVTODIAS                             
            ELSE                                                        
               MOVE ZEROS              TO  MVSB-VMOVTO                  
            END-IF                                                      
      ...
      *----------------------------------------------------------------*
           ...
           MOVE    MVSB-CDOCTO-LCTO    TO  POUPM4-CDOCTO-LCTO           
           MOVE    MVSB-CODLCTO-5POS   TO  POUPM4-CODLCTO-5POS          
      ...
      *----------------------------------------------------------------*
           ...
           WRITE FD-MVTODIAS           FROM MOVSUBC                     
      ...
      *----------------------------------------------------------------*
           ...
           DISPLAY '***************************************************'
           DISPLAY '**   ESTATISTICAS DE PROCESSAMENTO - POUP1064    **'
           DISPLAY '**-----------------------------------------------**'
