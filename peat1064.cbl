      ...
      *                                                                 
       ...
       01  WRK-ERRO-ARQUIVO.                                            
           ...
           05  WRK-OPERACAO-OP         PIC X(013) VALUE SPACES.
      ...
      *----------------------------------------------------------------*
           ...
           IF  (WRK-CHV-ARQSALDO       EQUAL   HIGH-VALUES) AND         
               ...
               (WRK-SUBGP          NOT EQUAL 51) OR                     
              ((WRK-OPERACAO      NOT EQUAL 'MP567') AND
               (WRK-LANCAMENTO         EQUAL 604 OR 605 OR 617 OR
                                             618 OR 607 OR 608))        
      ...
      *----------------------------------------------------------------*
           ...
           ELSE                                                         
            PERFORM 4000-GRAVAR-MVTODIAS                                
@BRQ        MOVE  WRK-VALOR           TO  WRK-VMOVTO                    
            IF WRK-DEB-CRED           EQUAL  '2'                        
      ...
      *----------------------------------------------------------------*
       3510-DEBITAR-CREDITO-DIA        SECTION.                         
           ...
           IF  WRK-MOVTO-DEBITAR       GREATER WRK-CREDT-DIA-MP         
               ...
               PERFORM 4000-GRAVAR-MVTODIAS                             
               MOVE    WRK-VALOR      TO  WRK-VMOVTO                    
@BRQ           COMPUTE WRK-MOVTO-DEBITAR=  WRK-MOVTO-DEBITAR -WRK-VMOVTO
@BRQ           COMPUTE WRK-SLD-CTA-MP   =  WRK-SLD-CTA-MP    -WRK-VMOVTO
               MOVE    ZEROS           TO  WRK-CREDT-DIA-MP             
           ELSE                                                         
               PERFORM 4000-GRAVAR-MVTODIAS                             
               MOVE    WRK-VALOR      TO  WRK-VMOVTO                    
@BRQ           COMPUTE WRK-CREDT-DIA-MP =  WRK-CREDT-DIA-MP - WRK-VMOVTO
@BRQ           COMPUTE WRK-SLD-CTA-MP   =  WRK-SLD-CTA-MP   - WRK-VMOVTO
...
@BRQ           MOVE   POUPSL-AGE-DE       TO  WRK-AUX-TAM-05            
@BRQ           MOVE   WRK-AUX-TAM-05-R    TO  WRK-AGENCIA               
@BRQ           MOVE   POUPSL-CTA-DE       TO  WRK-AUX-TAM-07            
@BRQ           MOVE   WRK-AUX-TAM-07-R    TO  WRK-CONTA                 
@BRQ           PERFORM 3600-CALCULAR-DIGITO                             
@BRQ           MOVE   WRK-B0431-DIGITO    TO  WRK-DIGITO                
...
@BRQ        PERFORM 3600-CALCULAR-DIGITO                                
@BRQ        MOVE   WRK-B0431-DIGITO    TO  WRK-DIGITO                   
@BRQ        MOVE    WRK-MOVTO-DEBITAR  TO  WRK-AUX-TAM-15               
@BRQ        MOVE    WRK-AUX-TAM-15-R   TO  WRK-VALOR                    
            PERFORM 4000-GRAVAR-MVTODIAS                                
            MOVE    WRK-VALOR          TO  WRK-VMOVTO                   
