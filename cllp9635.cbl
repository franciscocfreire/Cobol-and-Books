...
BSI        PERFORM 0000-TESTA-FILE-STATUS.                              
      ...
      *--- LINHA 1 ---*                                                 
           ...
           MOVE    WRK-CONTA         TO    LD1A-CONTA                   
           MOVE    '-'               TO    LD1A-HIFEN                   
                                                                        
           MOVE    '7'               TO    WRK-DIGITO                   
           MOVE     4                TO    WRK-TAMANHO                  
           CALL    'DIGITO'       USING    WRK-CONTA                    
                                           WRK-DIGITO                   
                                           WRK-TAMANHO                  
      ...
      *--- LINHA 4 ---*                                                 
           ...
           MOVE  WRK-MUNICIPIO   TO      LD4A-CID-AGE                   
...
ELA        MOVE  WRK-ANO-SIST    TO      LD4A-ANO                       
      ...
      *--- LINHA 5 ---*                                                 
           ...
           MOVE  WRK-NOME-AGE    TO      LD5A-NOME-AGE                  
           MOVE  WRK-END-AGE     TO      LD5A-ENDER-AGE                 
           MOVE  WRK-MUNICIPIO   TO      LD5A-CID-AGE.                  
      ...
      *---------------------------------------------------------------* 
       0000-CARRE-DET-A           SECTION.                              
           ...
           MOVE WRK-POSSIBIL (WRK-IND1)   TO LD2A-POSSIBIL  (WRK-IND1). 
           MOVE WRK-NATUREZA (WRK-IND1)   TO LD2A-COD-NAT  (WRK-IND1).  
           MOVE ' - '                     TO LD2A-HIFEN    (WRK-IND1).  
           MOVE WRK-DESCRIC (WRK-IND1)    TO LD2A-DESCRIC  (WRK-IND1).  
           ...
           MOVE WRK-VALOR    (WRK-IND1)   TO LD2A-VALOR    (WRK-IND1).  
           ...
           MOVE    WRK-NRO-SEQ            TO  LD6A-NRO-SEQ.             
...
BSI                 0000-GRAVA-ARQCEDD-FIM.                             
      ...
      *--- LINHA 1 ---*                                                 
           ...
           IF  WRK-DIGITO  EQUAL  'P'                                   
               MOVE    '0'           TO    LD1B-DIG-CTA                 
           ELSE                                                         
               MOVE    WRK-DIGITO    TO    LD1B-DIG-CTA.                
      ...
      *--- LINHA 4 ---*                                                 
           ...
           MOVE  WRK-MUNICIPIO  TO      LD4B-CID-AGE                    
ELA        MOVE  WRK-DIA-SIST    TO      LD4B-DIA                       
ELA        MOVE  WRK-MES-SIST    TO      LD4B-MES                       
ELA        MOVE  WRK-ANO-SIST    TO      LD4B-ANO                       
                                                                        
      *--- LINHA 5 ---*                                                 
                                                                        
           MOVE WRK-NOME-AGE    TO      LD5B-NOME-AGE                   
           MOVE WRK-END-AGE     TO      LD5B-ENDER-AGE                  
           MOVE WRK-MUNICIPIO   TO      LD5B-CID-AGE.                   
                                                                        
      *--- LINHA 7/8 -*                                                 
                                                                        
           IF  WRK-FLAG-DIR            EQUAL 'S'                        
               MOVE 'N'                   TO WRK-FLAG-DIR               
               MOVE WRK-LITERAL1          TO LD7B-LITERAL1              
               MOVE WRK-LITERAL2          TO LD8B-LITERAL2              
           ELSE                                                         
               MOVE SPACES                TO LD7B-LITERAL1              
                                             LD8B-LITERAL2.             
      ...
      *---------------------------------------------------------------* 
       0000-CARRE-DET-B1          SECTION.                              
           ...
           MOVE WRK-POSSIBIL (WRK-IND1)   TO LD2B-POSSIBIL (WRK-IND1).  
           MOVE WRK-NATUREZA (WRK-IND1)   TO LD2B-COD-NAT  (WRK-IND1).  
           MOVE ' - '                     TO LD2B-HIFEN    (WRK-IND1).  
           MOVE WRK-DESCRIC  (WRK-IND1)   TO LD2B-DESCRIC  (WRK-IND1).  
           ...
           MOVE WRK-VALOR    (WRK-IND1)   TO LD2B-VALOR    (WRK-IND1).  
           ...
           MOVE    WRK-NRO-SEQ            TO  LD6B-NRO-SEQ.             
      ...
      *---------------------------------------------------------------* 
       0000-MONT-EXT-LD2          SECTION.                              
           ...
           IF  WRK-TIPO   EQUAL   1                                     
               ...
               MOVE DAT-DIA          TO    CB-7B-DD-POST                
               MOVE DAT-MES          TO    CB-7B-MM-POST                
...
JGA        MOVE    SPACES            TO    CB1B-END-AG.                 
JGA        MOVE    SPACES            TO    CB2B-LADO2.                  
