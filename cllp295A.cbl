      ...
      *    BOOK RECRW810
           ...
           MOVE  SPC-CB-DT-MOVTO       TO  ECORW392-DAT-MOVI-APLIC-FUNCL
      ...
      *#################################################################
               ...
               IF SPC-NATUREZA(WRK-IND-DICD) EQUAL 'AR'
...
PEREGO     END-IF.
           ...
           IF (ACU-LIDOS-EMODLAVS      GREATER ZEROS) AND
              ...
              (ACU-ACESSOS-ECOR        GREATER ZEROS)
               DISPLAY '************* PROGRAMA CLLP295A *************'
               DISPLAY '*                                           *'
               DISPLAY '*  PROGRAMA CLLP295A ENCERRADO COM SUCESSO  *'
               DISPLAY '*                                           *'
               DISPLAY '************* PROGRAMA CLLP295A *************'
           END-IF.
      ...
      *----------------------------------------------------------------*
           ...
           IF  CK01-RESTART
               DISPLAY 'CLLP295A - PROCESSAMENTO COM RESTART'
           ...
           ELSE
               DISPLAY 'CLLP295A - PROCESSAMENTO NORMAL (SEM RESTART)'
           END-IF.
