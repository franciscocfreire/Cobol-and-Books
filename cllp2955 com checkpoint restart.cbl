      ...
      *' NOME DEVE SER DO DEVEDOR OU AVALISTA INFORMADO AO ECOR
           MOVE AVI-NOME-AVAL          TO RECRW810-NM-CLIENTE
                                          ECORW392-NOME-CLIENTE
      *#################################################################
           ...
           PERFORM UNTIL AVI-NATUREZA(WRK-IND-DICD) EQUAL SPACES OR
               ...
               DISPLAY 'AVI:  ' AVI-CONTRATO(WRK-IND-DICD)
               DISPLAY 'RECR: ' RECRW810-NU-CONTRATO(WRK-IND-DICD)
      ...
      *#################################################################
      *' NOME DEVE SER DO DEVEDOR OU AVALISTA INFORMADO AO ECOR         
           MOVE AVI-NOME-AVAL          TO RECRW820-NM-CLIENTE
                                           ECORW392-NOME-CLIENTE
      *#################################################################
           ...
           PERFORM UNTIL AVI-NATUREZA(WRK-IND-DICD) EQUAL SPACES OR
               ...
               DISPLAY 'AVI:  ' AVI-CONTRATO(WRK-IND-DICD)              
               DISPLAY 'RECR: ' RECRW820-NU-CONTRATO(WRK-IND-DICD)      
      ...
      *#################################################################
           ...
           PERFORM UNTIL AVI-NATUREZA(WRK-IND-DICD) EQUAL SPACES OR
               ...
               DISPLAY 'AVI:  ' AVI-CONTRATO(WRK-IND-DICD)
               DISPLAY 'RECR: ' RECRW830-NU-CONTRATO(WRK-IND-DICD)
      ...
      *#################################################################
           ...
           PERFORM UNTIL AVI-NATUREZA(WRK-IND-DICD) EQUAL SPACES OR
               ...
               DISPLAY 'AVI:  ' AVI-CONTRATO(WRK-IND-DICD)
               DISPLAY 'RECR: ' RECRW840-NU-CONTRATO(WRK-IND-DICD)
...
BRQ=E *       (CK01-CODIGO-RETORNO NOT EQUAL ZEROS)                     
               IF (RETURN-CODE         EQUAL 12)                        
BRQ=E *           (CK01-CODIGO-RETORNO EQUAL 12)                        
                   GOBACK                                               
               ELSE                                                     
