      ...
      *---------------------------------------------------------------* 
       ...
       01  WRK-REGTO.                                                   
           ...
           02  WRK-OCORRENCIAS OCCURS 7 TIMES.                          
               03  WRK-POSSIBIL    PIC X(01)            VALUE SPACES.   
               03  WRK-NATUREZA    PIC X(02)            VALUE SPACES.   
               03  WRK-VCMTO       PIC 9(09)     COMP-3 VALUE ZEROS.    
               03  WRK-VALOR       PIC 9(11)V99  COMP-3 VALUE ZEROS.    
               03  WRK-DESCRIC     PIC X(20)            VALUE SPACES.   
           02  WRK-TIPO            PIC 9(01)            VALUE ZEROS.    
           02  WRK-COD-ENT         PIC 9(01)            VALUE ZEROS.    
...
BSI        PERFORM 0100-TESTA-FILE-STATUS.                              
      ...
      *--- LINHA 1 ---*                                                 
           ...
           MOVE    WRK-CONTA         TO    CB-LD1A-CONTA                
           MOVE    '-'               TO    CB-LD1A-HIFEN                
                                                                        
           CALL    'BRAD0430'     USING    WRK-CONTA                    
                                           WRK-DIGITO.                  
      ...
      *--- LINHA 4 ---*                                                 
           ...
           MOVE  WRK-MUNICIPIO   TO      CB-LD4A-CID-AGE                
...
ELA        MOVE  WRK-ANO-SIST    TO      CB-LD4A-ANO                    
      ...
      *--- LINHA 5 ---*                                                 
           ...
           MOVE  WRK-NOME-AGE    TO      CB-LD5A-NOME-AGE               
           MOVE  WRK-END-AGE     TO      CB-LD5A-ENDER-AGE              
           MOVE  WRK-MUNICIPIO   TO      CB-LD5A-CID-AGE.               
      ...
      *---------------------------------------------------------------* 
           ...
           MOVE    WRK-AGENCIA       TO    CB-3A-AGEN.                  
           MOVE    '-'               TO    CB-3A-HIFEN.                 
           MOVE    '/'               TO    CB-3A-BARRA.                 
           MOVE    WRK-NOME-AGE      TO    CB-3A-NOME-AG.               
      ...
      *---------------------------------------------------------------* 
           ...
           MOVE    WRK-END-AGE       TO    CB-1A-END-AG.                
           ...
           MOVE    WRK-MUNICIPIO     TO    CB-2A-MUNICIPIO.             
           MOVE    WRK-EST-AG        TO    CB-2A-SIGLA.                 
...
BSI                 3600-GRAVA-ARQCEDD-FIM.                             
      ...
      *---------------------------------------------------------------* 
           ...
           PERFORM 1900-MONT-INT-CB-LD2.                                
                                                                        
           PERFORM 2400-MONT-EXT-CB-LD2.                                
      ...
      *---------------------------------------------------------------* 
       1900-MONT-INT-CB-LD2          SECTION.                           
      *---------------------------------------------------------------* 
                                                                        
      *--- LINHA 1 ---*                                                 
                                                                        
           MOVE    WRK-NOME-RESP     TO    CB-LD1B-NOME-RES             
           MOVE    WRK-CONTA         TO    CB-LD1B-CONTA                
           MOVE    '-'               TO    CB-LD1B-HIFEN                
                                                                        
           CALL    'BRAD0430'     USING    WRK-CONTA                    
                                           WRK-DIGITO.                  
                                                                        
           IF  WRK-DIGITO  EQUAL  '.'                                   
               MOVE    '0'           TO    CB-LD1B-DIG-CTA              
           ELSE                                                         
               MOVE    WRK-DIGITO    TO    CB-LD1B-DIG-CTA              
           END-IF.                                                      
      ...
      *--- LINHA 4 ---*                                                 
           ...
           MOVE  WRK-MUNICIPIO  TO      CB-LD4B-CID-AGE                 
ELA        MOVE  WRK-DIA-SIST    TO      CB-LD4B-DIA                    
ELA        MOVE  WRK-MES-SIST    TO      CB-LD4B-MES                    
ELA        MOVE  WRK-ANO-SIST    TO      CB-LD4B-ANO                    
           MOVE  '/'             TO      CB-LD4B-BARRA1                 
                                         CB-LD4B-BARRA2.                
                                                                        
      *--- LINHA 5 ---*                                                 
                                                                        
           MOVE WRK-NOME-AGE    TO      CB-LD5B-NOME-AGE                
           MOVE WRK-END-AGE     TO      CB-LD5B-ENDER-AGE               
           MOVE WRK-MUNICIPIO   TO      CB-LD5B-CID-AGE.                
      ...
      *---------------------------------------------------------------* 
       2400-MONT-EXT-CB-LD2          SECTION.                           
      *---------------------------------------------------------------* 
                                                                        
           MOVE    WRK-AGENCIA       TO    CB-3B-AGEN.                  
           MOVE    '-'               TO    CB-3B-HIFEN.                 
           MOVE    '/'               TO    CB-3B-BARRA.                 
           MOVE    WRK-NOME-AGE      TO    CB-3B-NOME-AG.               
           ...
           CALL  'POOL1260'       USING    WRK-AGENCIA                  
                                         ...
                                         WRK-TAMANHO.                   
           IF WRK-DIGITO  EQUAL  '.'                                    
              MOVE '0'               TO    CB-3B-DIG-AG                 
           ELSE                                                         
              MOVE WRK-DIGITO        TO    CB-3B-DIG-AG                 
           END-IF.                                                      
      ...
      *---------------------------------------------------------------* 
           ...
           MOVE    WRK-END-AGE       TO    CB-1B-END-AG.                
           MOVE   SPACES             TO    CB-1B-ECT.                   
           MOVE    WRK-CEP-AG        TO    WRK-TRATA-CEP-R.             
           MOVE    WRK-TR-CEP        TO    CB-2B-CEP.                   
           MOVE   '-'                TO    CB-2B-HIFEN.                 
           MOVE    WRK-TR-CEP-SUF    TO    CB-2B-AG-SUFIXO.             
           MOVE    WRK-MUNICIPIO     TO    CB-2B-MUNICIPIO.             
           MOVE    WRK-EST-AG        TO    CB-2B-SIGLA.                 
...
JGA        MOVE    SPACES            TO    CB-2B-LADO2.                 
...
RST                 3500-OBTEM-DADOS-FAC-FIM.                           
           ...
           PERFORM  3200-MONTA-BARRA-CIF      THRU                      
                    3200-MONTA-BARRA-CIF-FIM.                           
           MOVE  WRK-LINHA-RETORNO-9010  TO   CB-LCIF1-AREA-D.          
           MOVE  WRK-LINHA-NUMERO-9010   TO   CB-LCIF2-AREA-D.          
BSI        PERFORM  3600-GRAVA-ARQCEDD        THRU                      
BSI                 3600-GRAVA-ARQCEDD-FIM.                             
...
RST            DISPLAY '*********** CLLP0781 **********'                
RST            DISPLAY '* CLLP0781-ERRO NO ACESSO AO  *'                
